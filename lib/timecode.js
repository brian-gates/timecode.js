/* global exports, module, global, self, define */
...
(function() {
  ...
  // Export Timecode strategy taken from lodash.js
  ...
  // Check for `exports` after `define` in case a build optimizer adds an `exports` object.
    ...
    if (moduleExports) {
      (freeModule.exports = Timecode).Timecode = Timecode;
    }
    // Export for Narwhal or Rhino -require.
    else {
      freeExports.Timecode = Timecode;
    }
  }
  else {
